      ...
      <div class="row">
        ...
        <div id="content" class="<?php echo $class; ?>">
          <div class="form-style-2">
            ...
            <h4 class="heading sp2"><?php echo $heading_title; ?></h4>
            <?php if ($products) { ?>
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right <?php echo ($product['stock'] == 'In Stock') ? 'inStock' : ''; ?>"><?php echo $product['stock']; ?></td>
                  ...
                  <td class="text-right"><button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-cart"><i class="fa fa-shopping-cart"></i></button>
                    <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-rmv"><i class="fa fa-times"></i></a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
