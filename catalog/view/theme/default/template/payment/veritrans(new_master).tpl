...
<?php else: ?>
  ...
  <?php if ($veritrans_payment_type == 'vtweb'): ?>
  ...
  <?php else: ?>
    ...
    <?php if ($veritrans_payment_type == 1): ?>
      <script type="text/javascript">
        $(function() {
          $.getScript('https://payments.veritrans.co.id/vtdirect/veritrans.min.js')
            .done(function() {

              Veritrans.client_key = '<?php echo $client_key_v1 ?>'; // please add client-key from veritrans
      ...
      <script>
        ...
        function(){
          ...
          $.getScript(url).done(function() {
            ...
            <?php endif ?>
            Veritrans.client_key = '<?php echo $client_key_v2 ?>'; // please add client-key from veritrans
