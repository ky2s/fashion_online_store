<form class="form-horizontal">
    ...
    <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group required">
                    <div class="col-sm-12">
                        <label class="col-sm-12" for="input-shipping-name">Fullname</label>
                        <input type="text" name="name" value="" placeholder="Fullname" id="input-shipping-name" class="form-control" />
                    </div>
                </div>
            </div>
        </div>        
        ...
        <div class="form-group required">
            <div class="col-sm-12">
                <label class="col-sm-12" for="input-shipping-address-1"><?php echo $entry_address_1; ?></label>
                <textarea name="address_1" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" cols="30" rows="4" class="form-control"></textarea>
            </div>
        </div>
        <input type="hidden" name="address_2" value=""  id="input-shipping-address-2" class="form-control" />

        <div class="row">
            <div class="col-sm-6">
                <div class="form-group required">
                    <div class="col-sm-12">
                        <label class="col-sm-12" for="input-shipping-country"><?php echo $entry_country; ?></label>
            ...
            <div class="col-sm-6">
                <div class="form-group required">
                    <div class="col-sm-12">
                        <label class="col-sm-12" for="input-shipping-zone"><?php echo $entry_zone; ?></label>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group required">
                    <div class="col-sm-12">
                        <label class="col-sm-12" for="input-shipping-city"><?php echo $entry_city; ?></label>
            ...
            <div class="col-sm-6">
                <div class="form-group required">
                    <div class="col-sm-12">
                        <label class="col-sm-12" for="input-shipping-postcode"><?php echo $entry_postcode; ?></label>
        ...
        <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <div class="col-sm-12">
                <label class="col-sm-12" for="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
    ...
    <div class="buttons clearfix">
        ...
        <input type="button" value="BACK" id="backto-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
        <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
...
//added by wian
$('#backto-payment-address').on('click', function(){
    $('#collapse-payment-address').addClass('in');
    $('#collapse-payment-address').css({'height':'auto'});
    $('#collapse-payment-address').parent().show();

    $('#collapse-shipping-address').removeClass('in');
    $('#collapse-shipping-address').parent().hide();

    $('.head-step-checkout li[data-step=3]').removeClass('active');
});
//added by wian


$('#collapse-shipping-address select').selectpicker();
...
$('#collapse-shipping-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
      ...
      $('#collapse-shipping-address select[name=\'zone_id\']').selectpicker("refresh");
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
...
$(document).on('change', '#collapse-shipping-address select[name=\'zone_id\']', function() {
