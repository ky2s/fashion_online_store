    ...
    <div class="panel-body">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <select name="city_id" id="input-city" class="form-control" data-live-search="true">
            	<option selected="selected" value=""><?php echo $text_none; ?></option>
            </select>
          </div>
        </div>
...
$('#button-quote').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&city_id=' + $('select[name=\'city_id\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['country']) {
					$('select[name=\'country_id\'] ~ .btn-group').after('<div class="text-danger">' + json['error']['country'] + '</div>');
				}

				if (json['error']['zone']) {
					$('select[name=\'zone_id\'] ~ .btn-group').after('<div class="text-danger">' + json['error']['zone'] + '</div>');
				}

				if (json['error']['city']) {
					$('select[name=\'city_id\'] ~ .btn-group').after('<div class="text-danger">' + json['error']['city'] + '</div>');
				}
...
//$('select[name=\'zone_id\']').val($("select[name=\'zone_id\'] option:eq(1)").val()).trigger('change');
});
//--></script>
    </div>
  </div>
