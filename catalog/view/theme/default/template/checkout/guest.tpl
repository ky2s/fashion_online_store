        ...
        <fieldset id="address">
            ...
            <div class="form-group required">
                ...
                <select name="city" id="input-payment-city" class="form-control">
                    ...
                    <?php if ($val['city_id'] == $city) { ?>
                    <option value="<?php echo $val['city_id']; ?>" selected="selected"><?php echo $val['name']; ?></option>
                    <?php } else { ?>
...
<div class="buttons">
    <!-- <div class="pull-right"> -->
        ...
        <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
    <!-- </div> -->
</div>
