<div class="row">
    <div class="form-horizontal form-style-2 no-padding">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="col-sm-12" for="input-payment-name">Full Name</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="col-sm-12" for="input-payment-email"><?php echo $entry_email; ?></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group required">                            
                            <?php foreach ($custom_fields as $custom_field) { ?>
                                ...
                                <div class="col-sm-12">                                    
                                    <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="" data-sort="<?php echo $custom_field['sort_order']; ?>">
                                        <label class="" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                                        <!-- <div class="input-group date"> -->
                                            <input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control input-birth-date" />
                                        <!-- </div> -->
                                    </div>
                                </div>
                                <?php } ?>
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-password"><?php echo $entry_password; ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-confirm"><?php echo $entry_confirm; ?></label>
                ...
                */?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-address-1"><?php echo $entry_address_1; ?></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-country"><?php echo $entry_country; ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-zone"><?php echo $entry_zone;; ?></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-city"><?php echo $entry_city; ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group required">
                            <div class="col-sm-12">                                
                                <label class="" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pull-right">
                <label for="txt_agree">            
                    <?php echo $text_agree; ?> &nbsp;
                    <input type="checkbox" name="agree" value="1" id="txt_agree" />
                </label>
            </div>
        </div>
    </div>
    <div class="buttons clearfix">        
        <input type="button" value="BACK" id="backto-checkout-options" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
        <input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
    </div>
<?php } else { ?>
<div class="buttons clearfix">
        <input type="button" value="BACK" id="backto-checkout-options" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-grey" />
...
//added by wian
$('#backto-checkout-options').on('click', function(){
    $('#collapse-checkout-option').addClass('in');
    $('#collapse-checkout-option').css({'height':'auto'});
    $('#collapse-checkout-option').parent().show();

    $('#collapse-payment-address').removeClass('in');
    $('#collapse-payment-address').parent().hide();

    $('.head-step-checkout li[data-step=2]').removeClass('active');
});
