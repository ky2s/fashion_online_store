                ...
                <div id="content" class="<?php echo $class; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="<?php echo $class; ?>">
                            ...
                            <h1 class="heading-prod-detail"><?php echo $heading_title; ?></h1>
                            ...
                            <div id="product">
                                        ...
                                        <?php if ($option['type'] == 'radio') { ?>
                                            ...
                                            <div class="form-group custom-check">
                                                <div id="input-option">
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="option_color" value="#000">
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="option_color" value="#222842">
                                                            <div class="item-check">
                                                                <span class="color" style="background: #222842"></span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="option_color" value="#e5e5e7">
                                                            <div class="item-check">
                                                                <span class="color" style="background: #e5e5e7"></span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="option_color" value="#c99a70">
                                                            <div class="item-check">
                                                                <span class="color" style="background: #c99a70"></span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?> custom-check">
                                ...
                                <div class="form-group to-add-bag">
                                    ...
                                    <!-- <br /> -->
                                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block btn-white-grey"><?php echo $button_cart; ?></button>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row item-desc-prod">
                                    ...
                                    <div class="col-sm-8 item-col-detail">
                                        <ul>
                                            <li>Model is 170 cm Wearing size M</li>
                                            <li>
                                                <p>Slim fit</p>
                                                <p>Take your usual size</p>
                                                <p>Size up if looser fit is desired</p>                                            
                                            </li>
                                            <li>
                                                100% combed cotton, pre-shrunk, Machine wash cold, tumble dry low
                                            </li>
                                            <li>
                                                Made in Los Angeles, USA See the factory Questions about fit? Email fit@everlane.com
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row item-desc-prod">
                                    ...
                                    <div class="col-sm-8 item-col-detail">
                                        <p>
                                            The classic pocket T-shirt. The fabric is a lightweight yet durable cotton that gets softer over time.
                                        </p>
                                    </div>
                                </div>
                                <div class="row item-desc-prod">
...
$('#button-cart').on('click', function() {
  //console.log($('#product input[type=\'radio\']'));return false;
  $.ajax({
