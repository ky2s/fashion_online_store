                    ...
                    <div class="menu-foot">
                        ...
                        <ul>
                            ...
                            <?php if ($isLogged) { ?>
                                ...
                                <li><a href="<?php echo $refund_url ?>" class="ws-nowrap">Shipping Refund</a></li>
                            <?php }else{?>
                                ...
                                <li><a href="#"  onclick="$('#refund-red').val('refund-red');return false;"  class="quick_signup ws-nowrap">Shipping Refund</a>
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-8">
                            <div class="subscribe-caption in">
                                <h3>Refer a friend. Earn points when they purchase.</h3>
                                <input type="text" readonly="" value="<?php echo $referral_url ?>">
                            </div>
                        </div>
                        <?php }?>
