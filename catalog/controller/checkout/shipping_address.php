...
class ControllerCheckoutShippingAddress extends Controller {
	...
	public function save() {
		...
		//this custom delivery detail skiping
		$this->request->post['shipping_address'] = "existing";
		$this->request->post['address_id'] = $this->session->data['payment_address']['address_id']; //get address id diambil dri session payment address untuk customer yg sebelumnya belum mempunyai address  
