...
class ControllerCommonHeaderHome extends Controller {
	...
	public function index() {
		...
		// 			//$this->response->redirect($this->url->link('referral-page'));
		// 		}
		...
		//pre($this->session->data['tracking']);
		$data['base'] = $server;
		...
		$data['banners'] = array();
		$results = $this->model_design_banner->getBannerActive(1); //1 is banner popup id \
