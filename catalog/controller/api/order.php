...
*/
			...
			//pre($order_info);
			if ($order_info) {
				$this->model_checkout_order->addOrderHistory($order_id, $this->request->post['order_status_id'], $this->request->post['comment'], $this->request->post['notify'],$this->request->post);

				$json['success'] = $this->language->get('text_success');
				$json['order_status_id'] =  $this->request->post['order_status_id'];
			} else {
				$json['error'] = $this->language->get('error_not_found');
			}
		}
