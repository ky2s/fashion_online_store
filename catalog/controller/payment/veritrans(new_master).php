...
class ControllerPaymentVeritrans extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = $this->process_order();

    $data['veritrans_payment_type'] = $this->config->get('veritrans_payment_type');
    $data['process_order'] = $this->url->link('payment/veritrans/process_order');
    $data['client_key_v1'] = $this->config->get('veritrans_client_key_v1');
    $data['client_key_v2'] = $this->config->get('veritrans_client_key_v2');
    $data['environment'] = $this->config->get('veritrans_environment');
    ...
    $this->response->setOutput($this->load->view($this->template));
  }
