...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$this->session->data['redirect'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $result['manufacturer_id']);
		}
	...
	public function info() {
		...
		if ($manufacturer_info) {			
			...
			foreach ($results as $result) {
				...
				$this->session->data['redirect'] = $this->url->link('product/product', 'manufacturer_id=' . $result['manufacturer_id'] . '&product_id=' . $result['product_id'] . $url);
			}
			...
			foreach($limits as $value) {
				...
				$this->session->data['redirect'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . $url . '&limit=' . $value);
			}
			...
			$this->session->data['redirect'] = $this->url->link('product/manufacturer/info', $url);
