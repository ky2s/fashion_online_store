...
class ControllerProductCompare extends Controller {
	public function index() {
		...
		$this->session->data['redirect'] = $this->url->link('product/compare');
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['successCustom']['button_comparison'] = sprintf($this->language->get('text_button_compare'), $this->url->link('product/compare'));
			## ##
		}
