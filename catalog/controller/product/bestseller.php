...
class ControllerProductBestseller extends Controller {
	public function index() {
		...
		$this->session->data['redirect'] = $this->url->link('product/bestseller', $url);
		...
		$product_total = $this->model_catalog_product->getProductsForBestSellerTotal($filter_data);

		$results = $this->model_catalog_product->getProductsForBestSeller($filter_data);
		...
		foreach($limits as $value) {
			...
			$this->session->data['redirect'] = $this->url->link('product/bestseller', $url . '&limit=' . $value);
		}
