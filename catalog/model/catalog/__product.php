...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		$status = isset($this->session->data['user_id']) ? "" : " AND p.status = '1' ";
		$store = isset($this->session->data['user_id']) ? "" : " AND p2s.store_id = '" . (int)$this->config->get('config_store_id') . "' ";
	...
	public function getProductByGroup($product_id) {
	...
	public function getProductsByGroupId($data = array(), $group_id) {
	...
	public function getProductsForCategoryByGroup ($data = array()) {
