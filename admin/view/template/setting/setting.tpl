      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class="gohide"><a href="#tab-local" data-toggle="tab"><?php echo $tab_local; ?></a></li>
            <li><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <li class="gohide"><a href="#tab-ftp" data-toggle="tab"><?php echo $tab_ftp; ?></a></li>
            <li><a href="#tab-mail" data-toggle="tab"><?php echo $tab_mail; ?></a></li>
            <li class="gohide"><a href="#tab-fraud" data-toggle="tab"><?php echo $tab_fraud; ?></a></li>
            <li class="gohide"><a href="#tab-server" data-toggle="tab"><?php echo $tab_server; ?></a></li>
          </ul>
            ...
            <div class="tab-pane" id="tab-social">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-facebook">                  
                  <span data-toggle="tooltip" title="<?php echo $help_facebook; ?>">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-twitter">
                  <span data-toggle="tooltip" title="<?php echo $help_twitter; ?>">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-instagram">                  
                  <span data-toggle="tooltip" title="<?php echo $help_instagram; ?>">
