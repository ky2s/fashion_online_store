    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <?php } ?>
          <?php if (!$wrap_total) { ?>
          <li><a href="#tab-wrapping" data-toggle="tab"><?php echo $tab_wrapping; ?></a></li>
          <?php } ?>
          <?php if (!$card_total) { ?>
          <li><a href="#tab-card" data-toggle="tab"><?php echo $tab_gift_card; ?></a></li>
          <?php } ?>
        ...
        <div class="tab-content">
          ...
          <?php } ?>
          <?php if ($wrap_total) { ?>
          <div class="tab-pane" id="tab-wrapping">
            <table class="table table-bordered">
              <thead>
                <tr>                  
                  <td class="text-left"><?php echo $column_wrap_name; ?></td>                               
                  <td class="text-left"><?php echo $column_wrap_image; ?></td>
                  <td class="text-right"><?php echo $column_total; ?></td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="text-left"><?php echo $wrap_name; ?></td>
                  <td class="text-left"><img src="<?php echo $wrap_image; ?>" alt="<?php echo $wrap_name; ?>"></td>
                  <td class="text-right"><?php echo $wrap_total; ?></td>
                </tr>
              </tbody>  
              </table>
              <?php if($wrap_comment) { ?>
              <div class="wrapComment">
              <header><?php echo $text_wrap_comment; ?></header>
              <p><?php echo $wrap_comment; ?></p>
              </div>
              <?php } ?>
          </div>
          <?php } ?>
          ...
          <div class="tab-pane" id="tab-card">
            <table class="table table-bordered">
              <thead>
                <tr>                  
                  <td class="text-left"><?php echo $column_gift_card_name; ?></td>                          
                  <td class="text-left"><?php echo $column_gift_card_image; ?></td>
                  <td class="text-right"><?php echo $column_total; ?></td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="text-left"><?php echo $card_name; ?></td>
                  <td class="text-left"><img src="<?php echo $card_image; ?>" alt="<?php echo $card_name; ?>"></td>
                  <td class="text-right"><?php echo $card_total; ?></td>
                </tr>
              </tbody>  
              </table>
              <?php if($card_comment) { ?>
              <div class="wrapComment">
              <header><?php echo $text_gift_card_comment; ?></header>
              <p><?php echo $card_comment; ?></p>
              </div>
              <?php } ?>
          </div>
          <?php } ?>
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="checkbox" checked="checked" name="notify" value="1" id="input-notify" />
                  </div>
                </div>
                <div class="form-group">
...
$('#button-history').on('click', function() {
  ...
  ?>
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) +'&nomor_resi=' + encodeURIComponent($('#nomor_resi').val()) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) <?php echo $log_admin; ?>,
		beforeSend: function() {
