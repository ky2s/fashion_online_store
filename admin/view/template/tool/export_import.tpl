...
<div id="content">
	...
	<div class="container-fluid">
		...
		<div id="export_import_notification">
		</div>
		<?php } ?>
							...
							<table class="form">
								...
								<tr id="range_type">
									<td style="vertical-align:top;"><?php echo $entry_range_type; ?><span class="help"><?php echo $help_range_type; ?></span><br />
										<?php /*<input type="radio" name="range_type" value="id" id="range_type_id"><?php echo $button_export_id; ?> &nbsp;&nbsp;
...
function getNotifications() {	
	$('#export_import_notification').addClass('alert alert-info');
