...
<link href="view/image/favicon.png" rel="icon" type="image/x-icon" />
<?php if ($description) { ?>
...
<?php if($username=='gositus'){ ?>
<style type="text/css">
  .gohide{display: block !important;}
</style>
<?php } ?>
</head>
<body>
<div id="container">
<header id="header" class="navbar navbar-static-top <?php echo $loginClass; ?>">
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a title="<?php echo $stores[0]['name']; ?>" href="<?php echo $stores[0]['href']; ?>" target="_blank"><i class="fa fa-laptop fa-lg"></i></a></li>
