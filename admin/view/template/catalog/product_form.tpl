      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class="gohide"><a href="#tab-recurring" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>
            <li><a href="#tab-discount" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
            <li><a href="#tab-special" data-toggle="tab"><?php echo $tab_special; ?></a></li>
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
            <li class="gohide"><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
          </ul>
            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required gohide">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo $entry_meta_keyword; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="text-left">
                          ...
                          <div id="file-uploader" class='pull-left'><noscript><p>Please enable JavaScript to use file uploader.</p><!-- or put a simple form for upload here --></noscript></div>
                          <!-- multi image uploader -->  
                          <div class="pull-left">
                          <?php if ($pim_status){?><a type="button" data-toggle="manager" title="<?php echo 'Upload Image'; ?>" class="btn btn-success"><i class="fa fa-upload"></i> <?php echo 'Upload Image'; ?></a>&nbsp;<?php } ?><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>                      
                          </div>
                        </td>
                    </tr>
                  </tfoot>
...
$('input[name=\'category\']').autocomplete({
    ...
    $.ajax({
      ...
      url: 'index.php?route=catalog/category/getparents&token=<?php echo $token; ?>&parrent_id=' +  encodeURIComponent(item['value']),

      dataType: 'json',

      success: function(json) {   
        $.each (json, function (data) {                        
            $('#product-category').append('<div id="product-category' + json[data].category_id + '"><i class="fa fa-minus-circle"></i> ' + json[data].name + '<input type="hidden" name="product_category[]" value="' + json[data].category_id + '" /></div>');            
        });
...
<script type="text/javascript"> 
  var uploader = new qq.FileUploader({ 
    ...
    action: 'index.php?route=tool/mupload&token=<?php echo $token;?>',
    allowedExtensions: ['jpg', 'jpeg', 'png', 'gif'], 
    onComplete: function(id, fileName, responseJSON) {      
      addMultiImage(responseJSON.fileName); 
      //$('.qq-upload-list').fadeOut( "slow"); 
    }, 
  }); 
