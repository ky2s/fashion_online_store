...
class ControllerCatalogManufacturer extends Controller {
	...
	public function add() {
		...
		if (isset($this->request->post['name'])) {
			$this->request->post['keyword'] = hyphenize(htmlspecialchars_decode($this->request->post['name']));	
		}
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['keyword']) > 0) {
			...
			do {
				...
				if(($url_alias_info && isset($this->request->get['manufacturer_id']) && $url_alias_info['query'] != 'manufacturer_id=' . $this->request->get['manufacturer_id']) || ($url_alias_info && !isset($this->request->get['manufacturer_id']))) {
