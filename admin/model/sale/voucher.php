	...
	public function sendVoucher($voucher_id) {		
		...
		if ($voucher_info) {
			...
			if ($order_info) {
				...
				$data['top_left'] 		= $base."view/image/top_left.png";
				$data['top_right'] 		= $base."view/image/top_right.png";
				$data['bottom_right'] 	= $base."view/image/bottom_right.png";
				$data['bottom_left'] 	= $base."view/image/bottom_left.png";
				$data['base'] = $base;				
				$data['logo'] = $base . 'view/image/logo.png';
