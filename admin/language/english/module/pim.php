...
// Entry
$_['entry_delete_def_image']      = '<span data-toggle="tooltip" title="If set to NO, the default image will be keeped as additional image.">Delete Default image from additinal image</span>';
