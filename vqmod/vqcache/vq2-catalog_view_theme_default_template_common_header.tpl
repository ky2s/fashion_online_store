  ...
  <div class="container">
    ...
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account_is_login; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account_is_login; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
            <?php if ($logged) { ?>
            <li><a href="<?php echo $account; ?>"><?php echo $text_account_is_login; ?></a></li>
            <li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li>
            <li><a href="<?php echo $transaction; ?>"><?php echo $text_transaction; ?></a></li>
            <li><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li>
			<li><a href="<?php echo $payment_confirmation; ?>"><?php echo $text_confirm_order; ?></a></li>
