...
<li><a href="<?php echo $productmanager_link; ?>"><?php echo $productmanager; ?></a></li>
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      <li class="gohide"><a href="<?php echo $installer; ?>"><?php echo $text_installer; ?></a></li>
      ...
      <li class="gohide"><a class="parent"><?php echo $text_paypal ?></a>
        <ul>
          <li><a href="<?php echo $paypal_search ?>"><?php echo $text_paypal_search ?></a></li>
			...
			<li id="extension" class="gohide"><a class="parent"><i class="fa fa-users fa-fw"></i> <span><?php echo $text_vendor_tool; ?></span></a>
			  <ul>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_users; ?></a>
        <ul>
          ...
          <li class="gohide"><a href="<?php echo $api; ?>"><?php echo $text_api; ?></a></li>
        </ul>
      </li>
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $error_log; ?>"><?php echo $text_error_log; ?></a></li>
