...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_coupon_newsletter'] = $this->language->get('text_coupon_newsletter');
		...
		$data['coupon_newsletter'] = $this->url->link('marketing/coupon_newsletter', 'token=' . $this->session->data['token'], 'SSL');
