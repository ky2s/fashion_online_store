<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $product; ?>"><?php echo $text_product; ?></a></li>
		<li><a href="<?php echo $productmanager_link; ?>"><?php echo $productmanager; ?></a></li>
      <li class="gohide"><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li><li><a href="<?php echo $filter; ?>"><?php echo $text_filter; ?></a></li>
      ...
      <li class="gohide"><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li>
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $modification; ?>"><?php echo $text_modification; ?></a></li>
      <li><a href="<?php echo $module; ?>"><?php echo $text_module; ?></a></li>
      <li><a href="<?php echo $shipping; ?>"><?php echo $text_shipping; ?></a></li>
      <li><a href="<?php echo $payment; ?>"><?php echo $text_payment; ?></a></li>
      <li><a href="<?php echo $total; ?>"><?php echo $text_total; ?></a></li>
      <li class="gohide"><a href="<?php echo $feed; ?>"><?php echo $text_feed; ?></a></li>
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $order_recurring; ?>"><?php echo $text_order_recurring; ?></a></li>
      ...
      <li class="gohide"><a class="parent"><?php echo $text_paypal ?></a>
        <ul>
  ...
  <li><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $affiliate; ?>"><?php echo $text_affiliate; ?></a></li>
      <li><a href="<?php echo $coupon; ?>"><?php echo $text_coupon; ?></a></li>
      <li><a href="<?php echo $coupon_newsletter; ?>"><?php echo $text_coupon_newsletter; ?></a></li>
  ...
  <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
      ...
      <li class="gohide"><a href="<?php echo $layout; ?>"><?php echo $text_layout; ?></a></li>
      <li><a href="<?php echo $user; ?>"><?php echo $text_users; ?></a>
        <ul class="gohide">
          <li><a ><?php echo $text_user; ?></a></li>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          <li class="gohde"><a href="<?php echo $location; ?>"><?php echo $text_location; ?></a></li>
          <li class="gohide"><a href="<?php echo $language; ?>"><?php echo $text_language; ?></a></li>
          <li class="gohide"><a href="<?php echo $currency; ?>"><?php echo $text_currency; ?></a></li>
          ...
          <li class="gohide"><a href="<?php echo $country; ?>"><?php echo $text_country; ?></a></li>
          <li class="gohide"><a href="<?php echo $zone; ?>"><?php echo $text_zone; ?></a></li>
          <li class="gohide"><a href="<?php echo $geo_zone; ?>"><?php echo $text_geo_zone; ?></a></li>
          <li class="gohide"><a class="parent"><?php echo $text_tax; ?></a>
            <ul>
              <li><a href="<?php echo $tax_class; ?>"><?php echo $text_tax_class; ?></a></li>
              <li><a href="<?php echo $tax_rate; ?>"><?php echo $text_tax_rate; ?></a></li>
            </ul>
          </li>
          <li class="gohide"><a href="<?php echo $length_class; ?>"><?php echo $text_length_class; ?></a></li>
          <li class="gohide"><a href="<?php echo $weight_class; ?>"><?php echo $text_weight_class; ?></a></li>
        </ul>
      </li>
    </ul>
  </li>
    ...
    <ul>
      <li><a class="parent"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li class="gohide"><a href="<?php echo $report_sale_tax; ?>"><?php echo $text_report_sale_tax; ?></a></li>
      ...
      <li><a class="parent"><?php echo $text_marketing; ?></a>
        <ul>
          ...
          <li class="gohide"><a href="<?php echo $report_affiliate; ?>"><?php echo $text_report_affiliate; ?></a></li>
          <li class="gohide"><a href="<?php echo $report_affiliate_activity; ?>"><?php echo $text_report_affiliate_activity; ?></a></li>
        </ul>
      </li>
    </ul>
  </li>
