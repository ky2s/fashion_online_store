...
<td class="text-right"><input type="radio" name="def_img" id="radio-input-image<?php echo $image_row; ?>" value="<?php  if (isset($product_image['image'])) { echo $product_image['image']; } ?>" class="form-control" /></td>        
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td colspan="2" class="text-left"><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button>                      
        ...
        <!-- multi image uploader -->  
         ...
         <!-- multi image uploader --> <div id="file-uploader"><noscript><p>Please enable JavaScript to use file uploader.</p><!-- or put a simple form for upload here --></noscript></div> <!-- multi image uploader --></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
