...
<div class="container">
  ...
  <div class="row"><?php #echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } */?>
    <div id="content" class="loginWrapper <?php echo $class; ?>"><?php echo $content_top; ?>
      <h1 class=""><?php echo $heading_title; ?></h1>
      <?php echo $text_description; ?>
      <div class="row">        
        <div class="col-sm-6">
          <div class="well">
            <h2 class="heading"><?php echo $text_returning_affiliate; ?></h2>
            <div class="wrapperAfterHeading">
              ...
              <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <a class="forgetPwd" href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a> </div>
        ...
        <div class="col-sm-6">
          <div class="well">
            <h2 class="heading"><?php echo $text_new_affiliate; ?></h2>
            <div class="wrapperAfterHeading">
