...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (isset($this->request->post['information_description'])) {
			...
			$this->request->post['keyword'] = hyphenize(htmlspecialchars_decode($iName));	
		}
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['keyword']) > 0) {
			...
			do {
				...
				if(($url_alias_info && isset($this->request->get['information_id']) && $url_alias_info['query'] != 'information_id=' . $this->request->get['information_id']) || ($url_alias_info && !isset($this->request->get['information_id']))) {
